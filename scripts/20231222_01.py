...
@dataclass
class Config:
    experiment_name: str = "20231222_01"
    n_fold: int = 5
    seed: int = 0
...
for class_idx in range(3):
    ...
    test = pd.merge(test, te, on='spc_common', how="right")
...
unused_cols = ["boroname", "nta_name", "spc_latin"]
...
train_folds_v2(
    ...
    "lgb",
    "health",
    ["health", "fold"] + unused_cols,
    [cat_col for cat_col in cat_cols if cat_col not in unused_cols],
...
# %% [markdown]
# - baseline(20231221_01): 0.35653867230742026
# - remove boroname, borocode: 0.3561775007619594
# - remove duplicated("boroname", "nta_name", "spc_latin"): 0.35653867230742026
