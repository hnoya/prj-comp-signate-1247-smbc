...
@dataclass
class Config:
    experiment_name: str = "20231231_02"
    n_fold: int = 5
    seed: int = 0
...
#parse_problem_prefix_list = ["Branch", "Metal", "Root", "Stones", "Trunk", "Wires"]
#for problem_prefix in parse_problem_prefix_list:
#    qua_cols += [f"problems_has_{problem_prefix}_index", f"problems_has_{problem_prefix}_count"]

qua_cols += [f"{cat_col}_ratio" for cat_col in cat_cols]
...
# - add problems_count (20231231_01): 0.3608654717126763
# - add each problems count and index: 
...
# - add problems_count (20231231_01): 0.3664672870707581
# - add each problems count and index: 
