...
@dataclass
class Config:
    experiment_name: str = "20231228_02"
    n_fold: int = 5
    seed: int = 0
...
# %% [markdown]
# - base (20231228_01): 0.3603891057941584
# - add ratio: 0.3603891057941584
# - add latitude, longitude: 0.3612396764144588
#    - ~~add stats: 0.359801590573158~~
# - add spc_common_pre/post: 0.35986064820712005
# - ~~remove latitude, longitude: 0.35721893588318393~~
# - ~~try boosting = dart~~
#    - ~~too long and fold_idx==0 got 0.351608.~~
# - add ymd: 0.36099044096590055
...
# %% [markdown]
# - base (20231228_01): 0.3627083825403204
# - add ratio: 0.362714993432869
# - add latitude, longitude: 0.36046173682598665
#     - ~~add stas: 0.3602135800562753~~
# - add spc_common_pre/post: 0.3647258352302702
# - ~~remove latitude, longitude: 0.3646649590224533~~
# - add ymd: 0.36431500437373465
