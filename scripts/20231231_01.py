...
@dataclass
class Config:
    experiment_name: str = "20231231_01"
    n_fold: int = 5
    seed: int = 0
...
# - ~~add problems parse: 0.35938149456657187~~
# - add spc_latin split: 0.3621894459369918
# - ~~add nta pre: 0.36146854530348543~~
# - add problems_count: 0.3608654717126763
...
# - ~~add problems parse: 0.3631681556780905~~
# - add spc_latin split: 0.3625736932898314
# - ~~add nta pre: 0.36024826280059963~~
# - add problems_count: 0.3664672870707581
